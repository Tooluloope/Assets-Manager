                ...
                <table id="personnels" class="table table-striped table-bordered  ">
                    ...
                    <tbody>
                         ...
                         <tr>
                            ...
                            <td><a style='color:#428bca;' href="{{ url('/equipment/'.$equipment->name.'?eid=') }}{{$equipment->id}}">{{$equipment->name}}</a></td>
                            <td>{{$equipment->category}}</td>
                            <td>{{$equipment->swl}}</td>
                            <td>{{$equipment->size}}</td>
                            <td>{{$equipment->current_location != 'Fabrication Yard' ? $equipment->project->location : 'Fabrication Yard'}}</td>
                            <td></td>
